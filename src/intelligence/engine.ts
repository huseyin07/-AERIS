...
function flow(transfer: Transfer): RankedFlow { return {id: transfer.id, txHash: transfer.txHash, from: transfer.from, to: transfer.to, amount: amount(transfer.value), blockNumber: transfer.blockNumber}; }
