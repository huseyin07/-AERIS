  ...
  function ask(value: string) {
    ...
    timer.current = setTimeout(() => {
      try {
        ...
        const failure: AerisAnswer = {message: "AERIS could not analyze the current observation. Try again.", summary: "AERIS could not analyze the current observation. Try again.", evidence: [], relatedAddresses: [], relatedTransferIds: [], intent: {type: "reset"}, scope: "current-window"};
